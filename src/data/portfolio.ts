...
export const CONTACT_CONFIG = {
  formEndpoint: "https://formspree.io/f/mvzypdvq",
...
const skills: Skill[] = [
  // Primary — largest constellation nodes
  {
    ...
    level: "primary",
    description:
      "Primary framework — 3+ years of production experience building scalable component systems",
  },
  {
    name: "TypeScript",
    category: "frontend",
    level: "primary",
    description:
      "Strictly typed throughout all projects; interfaces, generics, and utility types",
  },
  {
    name: "JavaScript",
    category: "frontend",
    level: "primary",
    description:
      "ES6+ — async/await, closures, prototypes, and performance patterns",
  },
  ...
  // Strong — medium nodes
  {
    ...
    level: "strong",
    description:
      "Complex state management for multi-customer forms and dispatch workflows",
  },
  {
    name: "React Query",
    category: "frontend",
    level: "strong",
    description: "Server state management, caching, and optimistic updates",
  },
  {
    name: "Node.js",
    category: "backend",
    level: "strong",
    description: "RESTful API development and backend optimisation",
  },
  {
    name: "Express.js",
    category: "backend",
    level: "strong",
    description: "MVC architecture, JWT auth, and API endpoint design",
  },
  {
    name: "MongoDB",
    category: "backend",
    level: "strong",
    description: "Primary database — schema design and query optimisation",
  },
  {
    name: "Cypress",
    category: "testing",
    level: "strong",
    description: "End-to-end test automation; achieved 85%+ coverage on NGAT",
  },
  {
    name: "Jest",
    category: "testing",
    level: "strong",
    description: "Unit and integration testing across frontend and backend",
  },
  {
    name: "React Testing Library",
    category: "testing",
    level: "strong",
    description: "Component-level testing with a user-behaviour-first approach",
  },
  ...
  // Familiar — smaller nodes
  {
    ...
    category: "mobile",
    level: "familiar",
    description: "Cross-platform mobile UI contributor on the IDLA project",
  },
  {
    name: "Socket.io",
    category: "backend",
    level: "familiar",
    description:
      "Real-time bidirectional communication; improved user engagement by 25%",
  },
  {
    name: "AG Grid",
    category: "frontend",
    level: "familiar",
    description:
      "High-performance data grids with bulk actions and custom renderers (Sekady)",
  },
  {
    name: "Mapbox API",
    category: "tools",
    level: "familiar",
    description:
      "Real-time geo-information and interactive project maps (Sekady)",
  },
  {
    name: "Firebase",
    category: "backend",
    level: "familiar",
    description: "Cloud database and real-time data sync",
  },
  {
    name: "MySQL",
    category: "backend",
  ...
  },
  {
    ...
    level: "familiar",
    description:
      "Advanced usage — cherry-picks, branch management, multi-env release coordination",
  },
  {
    name: "Jira",
    category: "tools",
    level: "familiar",
    description: "Agile/Scrum sprint planning and issue tracking",
  },
  {
    name: "Azure DevOps",
    category: "tools",
    level: "familiar",
    description: "CI/CD pipeline management and project tracking",
  },
  {
    name: "Postman",
    category: "tools",
  ...
  },
  {
    ...
    category: "frontend",
    level: "familiar",
    description: "Component-based responsive layout system",
  },
];
...
const metrics: Metric[] = [
  {
    ...
    description:
      "Improved dispatch workflow efficiency through validation logic, confirmation flows, and reusable UI systems on the NGAT platform",
    project: "NGAT",
  ...
  },
  {
    ...
    label: "Test Coverage",
    description:
      "Consistent frontend test coverage achieved using Cypress and Jest across the NGAT platform",
    project: "NGAT",
  ...
  },
  {
    ...
    description:
      "Reduced manual invoice processing steps by building bulk action capabilities with AG Grid on the Sekady platform",
    project: "Sekady",
    color: ACCENT_COLORS.cyan,
  },
  {
    ...
    description:
      "Improved API response times by 15–25% through targeted backend optimisation and segregated fetch operations on Sekady",
    project: "Sekady",
    color: ACCENT_COLORS.purple,
  },
  {
    ...
    description:
      "Resolved 10+ critical production bugs in the NGAT MCS feature covering invoicing, email delivery, broker fees, and API timeouts",
    project: "NGAT MCS",
  ...
  },
  {
    ...
    description:
      "Reduced UI error rate by 20% through systematic validation logic enhancements and confirmation flow improvements across NGAT",
    project: "NGAT",
